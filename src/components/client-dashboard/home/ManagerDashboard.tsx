...
/**
 * ManagerDashboard
 * Dashboard layout for Manager role
 * Shows restaurant-specific stats and operations
 */
        ...
        <div className="flex flex-col gap-8 w-full">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-default-500 dark:text-default-400">
              {t('managerDashboardDesc') || 'Manage restaurant operations and performance'}
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <RecentOrdersTable restaurantId={selectedRestaurant} limit={15} />
          </div>
        </div>
      </div>
    </div>
